...
class ProfileVC: UIViewController , UIImagePickerControllerDelegate ,UINavigationControllerDelegate ,UIGestureRecognizerDelegate ,Reloadtableviewdeleget {
    func ReloadData() {
        mapView.clear()
       viewDidLoad()
...
//        self.navigationController?.pushViewController(EditProfileVc(), animated: false)
    ...
    @objc func EditProfileAction() {
        ...
        Editprofilecontroller.deleget = self
