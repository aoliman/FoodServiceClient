...
struct SegmentioBuilderHome {
    ...
    private static func segmentioContent() -> [SegmentioItem] {
        return [
            ...
            SegmentioItem(title: "Party Cooker".localize(), image: #imageLiteral(resourceName: "map_marker_party_cooker-1").tint(with: #colorLiteral(red: 0.6352391243, green: 0.6353304982, blue: 0.6352103949, alpha: 1)), selectedImage: #imageLiteral(resourceName: "map_marker_party_cooker-1").tint(with: #colorLiteral(red: 0.08737478405, green: 0.735198617, blue: 0.8322803378, alpha: 1))),
             SegmentioItem(title: "Home Cooker".localize(), image: #imageLiteral(resourceName: "map_marker_home_cooker").tint(with: #colorLiteral(red: 0.6352391243, green: 0.6353304982, blue: 0.6352103949, alpha: 1)), selectedImage: #imageLiteral(resourceName: "map_marker_home_cooker").tint(with: #colorLiteral(red: 0.08737478405, green: 0.735198617, blue: 0.8322803378, alpha: 1))),
             ...
             SegmentioItem(title: "Resturante".localize(), image: #imageLiteral(resourceName: "ic_bitmap").tint(with: #colorLiteral(red: 0.6352391243, green: 0.6353304982, blue: 0.6352103949, alpha: 1)), selectedImage: #imageLiteral(resourceName: "ic_bitmap").tint(with: #colorLiteral(red: 0.08737478405, green: 0.735198617, blue: 0.8322803378, alpha: 1)))
    ...
    private static func segmentioStates() -> SegmentioStates {
        ...
        return SegmentioStates(
            defaultState: segmentioState(
                ...
                titleFont: .appFont(ofSize:18) ,
                titleTextColor: .gray
            ),
            selectedState: segmentioState(
                backgroundColor: .clear,
                titleFont: .appFontBold(ofSize: 20),
