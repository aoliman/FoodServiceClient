...
class SideMenuViewController: UITableViewController, ReloadSideMenuDelegate {
    ...
    var meunItems = ["Home", "Profile", "My Orders","Cart","Settings", "Contact Us","About", "Logout"]
    var icons = ["fa-home", "fa-user","fa-list-ol", "fa-cog", "fa-phone","fa-info","fa-sign-out"]
...
//            }
            ...
            case "Cart":
                ...
                let AddOrder : AddOrder = storyboard.instantiateViewController(withIdentifier: "AddOrder") as! AddOrder
               
                let appToolbarController = AppToolbarController(rootViewController: AddOrder )
                appToolbarController.toolbar.title = "Cart".localized()
                appToolbarController.mytitle="Cart".localize()
                self.navigationDrawerController?.transition(to: appToolbarController)
...
//                self.navigationDrawerController?.transition(to: appToolbarController)
            ...
            case "My Orders":
//                let appToolbarController = AppToolbarController(rootViewController: MyOrdersVC())
...
//
                ...
                let sideMenuViewController = SideMenuViewController()
                let appToolbarController = AppToolbarController(rootViewController: ordersVC)
                //                appToolbarController.toolbar.title = "My Orders".localized()
            ...
            case "Settings":
                let appToolbarController = AppToolbarController(rootViewController: SettingViewController())
                appToolbarController.toolbar.title = "Settings".localized()
            ...
            case "Contact Us":
                ...
                let sideMenuViewController = SideMenuViewController()
                let appToolbarController = AppToolbarController(rootViewController: ContactUsVC)
            ...
            case "About":
                ...
                let sideMenuViewController = SideMenuViewController()
                let appToolbarController = AppToolbarController(rootViewController: AboutUsVc)
