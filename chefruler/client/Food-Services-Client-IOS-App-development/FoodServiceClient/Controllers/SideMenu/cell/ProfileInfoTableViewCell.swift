...
class ProfileInfoTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        userImage.layer.cornerRadius = userImage.layer.frame.height / 2.2
        ...
        if (!didSetupConstraints) {
            ...
            userImage.snp.makeConstraints {
                ...
                if #available(iOS 11.0, *) {
                    ...
                    make.centerY.equalTo(self.snp.centerY).offset(insets.top*2)
                } else {
            ...
            onlineStatusLabel.snp.makeConstraints {
                make in
                if Localize.currentLanguage() == "ar" {
                    make.right.equalTo(userImage.snp.left).offset(38)
