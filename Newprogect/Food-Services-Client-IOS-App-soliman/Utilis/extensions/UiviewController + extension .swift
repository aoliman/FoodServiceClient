...
extension UIViewController {
    ...
    func setupNavigationBar() {
        ...
        self.navigationController?.navigationItem.titleLabel.adjustsFontSizeToFitWidth = true
    ...
    func changeTitleAttribute() {
        self.navigationController?.navigationBar.titleTextAttributes =
            [NSAttributedStringKey.foregroundColor: UIColor.white,
             NSAttributedStringKey.font: UIFont.appFontRegular(ofSize: 16)]
        UIBarButtonItem.appearance().setTitleTextAttributes([NSAttributedStringKey.foregroundColor: UIColor.white,
                                                             NSAttributedStringKey.font: UIFont.appFontRegular(ofSize: 16)], for: .normal)
