       ...
       self.navigationController?.navigationBar.tintColor = .white
        ...
        if ispartycooker {
            ...
            if(type == 1){
                ...
                LoadAllproducte(page: page, limit: limit, status:nameofitem, lat: mylocation.coordinate.latitude, long:  mylocation.coordinate.longitude, raduis: 100000)
            }
        }
    ...
    dropDown.selectionAction = { [unowned self] (index: Int, item: String) in
       ...
       // case "Party Cooker" : self.nameofitem = "PARTY_COOKER"
        ...
        if(self.type == 1){
            ...
            self.LoadAllproducte(page: self.page, limit: self.limit, status:self.nameofitem, lat: self.mylocation.coordinate.latitude, long:  self.mylocation.coordinate.longitude, raduis: 100000)
